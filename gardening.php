...
<head>
    ...
    <title>Gardening and farmings</title>
    <style>
        /* Modal Styles */
        .modal {
...
<div class="wrapper">
    <nav class="nav">
        ...
        <div class="nav-menu" id="navMenu">
            <ul>
                ...
                <li><a href="#" class="link active">Gardening and farmings</a></li>
    ...
    <section class="user-products">
        ...
        <div class="products-list">
            ...
            $fav_stmt = $fav_conn->prepare($fav_query);
